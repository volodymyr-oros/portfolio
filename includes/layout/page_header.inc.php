            ...
            <nav id="primary-navigation" class="navigation" area-visible="false">
                <ul class="menu">
                    <li class="menu__item menu__item--first-lvl">
                        <a href="#" class="menu__link">Category</a>
                    </li>
                    <li class="menu__item menu__item--first-lvl menu__item--nested">
                        <span class="menu__link">Account</span>
                        <ul class="menu__sub-menu">
                            <li class="menu__item menu__item--second-lvl">
                                <a href="/customer/signup" class="menu__link">Sign up</a>
                            </li>
                            <li class="menu__item menu__item--second-lvl">
                                <a href="/customer/login" class="menu__link">Log in</a>
                            </li>
                        </ul>
                    </li>
                </ul>
